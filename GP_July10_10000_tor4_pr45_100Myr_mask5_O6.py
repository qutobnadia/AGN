...
for fname in List_diir:
    ...
    fig.suptitle(r"Precessing kinetic jet with higher energy flux : Snapshot #" + str(sorted[oo]+1) + " with O6 Mass & Mask 5", fontsize=17, x=0.5, y=1.5) #set a figure title on top
