...
for fname in List_diir:
    ...
    Default_dir = '/n/home13/nqutob/AGN_Feedback/ion_snapshots/' + 'Mg2_t95_3000_tor4_lower_mask5'
    ...
    plt.savefig(Default_dir + '/Fire' + str(sorted[oo]).zfill(3) + '_Mg2_t95_3000_tor4_lower_mask5' + '.png', dpi = 600, transparent = True, bbox_inches='tight')
