...
for fname in List_diir:
    ...
    Oxygen6_mass = ds.all_data()[('gas', 'O_p6_mass')].in_units('Msun') # should give Msun/kpc^2 # THIS LINE ISNT DONE!!!!
    #Oxygen6_mass = ds.all_data()[('gas', 'O_p6_ion_fraction')] 
    print("Checkpoint 2")
    ...
    #Particles = sphviewer.Particles(Gas_location[mask_z], Oxygen6_mass[mask_z], hh[mask_z]) # the 'Oxygen6_mass' is what we will be modifying each time to be different parameters 
    ...
    fig.suptitle(r"Precessing kinetic jet with higher energy flux : Snapshot #" + str(sorted[oo]+1) + " with O7 Mass", fontsize=17, x=0.5, y=1.5)
    ...
    cb.set_label(label='M_sun/Kpc^2', size='large', weight='bold')
...
#start of 2nd panel
    ...
    Default_dir = '/n/home13/nqutob/AGN_Feedback/ion_snapshots/' + 'm12_mcvt_m2_10000_tor4_pr45_100Myr'
    Default_dir_pdf = '/n/home13/nqutob/AGN_Feedback/ion_snapshots/' + 'm12_mcvt_m2_10000_tor4_pr45_100Myr_pdf'
    ...
    plt.savefig(Default_dir + '/Fire' + str(sorted[oo]).zfill(3) + '_m12_mcvt_m2_10000_tor4_pr45_100Myr' + '.png', dpi = 600, transparent = True, bbox_inches='tight')
    plt.savefig(Default_dir_pdf + '/Fire' + str(sorted[oo]).zfill(3) + '_m12_mcvt_m2_10000_tor4_pr45_100Myr' + '.pdf', dpi = 600, transparent = True, bbox_inches='tight')
