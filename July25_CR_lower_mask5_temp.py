...
for fname in List_diir:
    ...
    fig.suptitle(r"Cosmic Ray jet with lower energy flux : Snapshot #" + str(sorted[oo]+1) + " with Temperature & Mask 5", fontsize=17, x=0.5, y=1.5) #set a figure title on top
    ...
    Default_dir = '/n/home13/nqutob/AGN_Feedback/ion_snapshots/' + 'CR_lower_mask5_temp'
    ...
    plt.savefig(Default_dir + '/Fire' + str(sorted[oo]).zfill(3) + '_CR_lower_mask5_temp' + '.png', dpi = 600, transparent = True, bbox_inches='tight')
