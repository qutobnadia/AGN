...
for fname in List_diir:
    ...
    fig.suptitle(r"Hot thermal jet with higher energy flux : Snapshot #" + str(sorted[oo]+1) + " with O7 Mass", fontsize=17, x=0.5, y=1.5)
...
#start of 2nd panel
    ...
    Default_dir = '/n/home13/nqutob/AGN_Feedback/ion_snapshots/' + 'm12_mcvt_m2_t95_3000_tor4'
    Default_dir_pdf = '/n/home13/nqutob/AGN_Feedback/ion_snapshots/' + 'm12_mcvt_m2_t95_3000_tor4_pdf'
    ...
    plt.savefig(Default_dir + '/Fire' + str(sorted[oo]).zfill(3) + '_m12_mcvt_m2_t95_3000_tor4' + '.png', dpi = 600, transparent = True, bbox_inches='tight')
    plt.savefig(Default_dir_pdf + '/Fire' + str(sorted[oo]).zfill(3) + '_m12_mcvt_m2_t95_3000_tor4' + '.pdf', dpi = 600, transparent = True, bbox_inches='tight')
