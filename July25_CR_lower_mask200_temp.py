...
print("Checkpoint 0")
Directory_path = '/n/holylfs05/LABS/hernquist_lab/AGN_Feedback_Fire/m12_mcvt_m2_t7_3000_tor3_CR10_t4_lower/output/'
...
for fname in List_diir:
    ...
    fig.suptitle(r"Cosmic Ray jet with lower energy flux : Snapshot #" + str(sorted[oo]+1) + " with Temperature & Mask 200", fontsize=17, x=0.5, y=1.5) #set a figure title on top
    ...
    Default_dir = '/n/home13/nqutob/AGN_Feedback/ion_snapshots/' + 'CR_lower_mask200_temp'
    #Default_dir_pdf = '/n/home13/nqutob/AGN_Feedback/ion_snapshots/' + 'm12_mcvt_m2_CR_mask_pdf'
    ...
    plt.savefig(Default_dir + '/Fire' + str(sorted[oo]).zfill(3) + '_CR_lower_mask200_temp' + '.png', dpi = 600, transparent = True, bbox_inches='tight')
    #plt.savefig(Default_dir_pdf + '/Fire' + str(sorted[oo]).zfill(3) + '_m12_mcvt_m2_CR_mask_O6' + '.pdf', dpi = 600, transparent = True, bbox_inches='tight')
