...
for fname in List_diir:
    ...
    Default_dir = '/n/home13/nqutob/AGN_Feedback/ion_snapshots/' + 't95_3000_tor4_mask200_temperature'
    ...
    plt.savefig(Default_dir + '/Fire' + str(sorted[oo]).zfill(3) + '_t95_3000_tor4_mask200_temperature' + '.png', dpi = 600, transparent = True, bbox_inches='tight')
