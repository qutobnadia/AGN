...
for fname in List_diir:
    ...
    fig.suptitle(r"Hot thermal jet with higher energy flux : Snapshot #" + str(sorted[oo]+1) + " with Mass Density & Mask 200", fontsize=17, x=0.5, y=1.5) #set a figure title on top
    ...
    Default_dir = '/n/home13/nqutob/AGN_Feedback/ion_snapshots/' + 't95_3000_tor4_mask200_mass'
    ...
    plt.savefig(Default_dir + '/Fire' + str(sorted[oo]).zfill(3) + '_t95_3000_tor4_mask200_mass' + '.png', dpi = 600, transparent = True, bbox_inches='tight')
