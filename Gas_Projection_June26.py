...
for fname in List_diir:
    ...
    fig.suptitle(r"Snapshot: " + str(sorted[oo]+1), fontsize=17, x=0.5, y=1.4)
    ...
    Default_dir = '/n/home13/nqutob/AGN_Feedback/mass_snapshots/' + 'm12_mcvt_m2_10000_tor4_pr45_100Myr'
    Default_dir_pdf = '/n/home13/nqutob/AGN_Feedback/mass_snapshots/' + 'm12_mcvt_m2_10000_tor4_pr45_100Myr_pdf'
