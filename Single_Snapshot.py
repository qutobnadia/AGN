...
for fname in List_diir:
    ...
    Default_dir = '/n/home13/nqutob/AGN_Feedback/snapshots100/' + jet
    ...
    plt.savefig(Default_dir + '/Fire' + str(sorted[oo]).zfill(3) + '_' + jet + '_mask200_O6' + '.png', dpi = 600, transparent = True, bbox_inches='tight')
