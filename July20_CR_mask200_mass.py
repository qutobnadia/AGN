...
for fname in List_diir:
    ...
    fig = plt.figure(1,figsize=(15,5))
    fig.suptitle(r"Cosmic Ray Jet : Snapshot #" + str(sorted[oo]+1) + " with Mass & Mask 200", fontsize=17, x=0.5, y=1.5) #set a figure title on top
    plt.subplots_adjust(top =1.8, bottom=0.2, hspace=0.3, wspace=0.3)
    ...
    Default_dir = '/n/home13/nqutob/AGN_Feedback/ion_snapshots/' + 'CR_mask200_mass'
    #Default_dir_pdf = '/n/home13/nqutob/AGN_Feedback/ion_snapshots/' + 'm12_mcvt_default_64_mask200_pdf'
    ...
    plt.savefig(Default_dir + '/Fire' + str(sorted[oo]).zfill(3) + '_CR_mask200_mass' + '.png', dpi = 600, transparent = True, bbox_inches='tight')
