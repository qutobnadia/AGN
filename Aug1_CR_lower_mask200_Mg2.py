...
diir =  Directory_path  + 'snapshot_100.hdf5'
...
fname = Directory_path  + 'snapshot_100.hdf5'
...
fig.suptitle(r"Cosmic Ray jet w/ lower energy flux : Snapshot #" + str(100+1) + " with Mg2 Mass & Mask 200", fontsize=17, x=0.5, y=1.5) #set a figure title on top
...
plt.savefig(Default_dir + '/Fire' + str(100).zfill(3) + '_CR_lower_mask200_Mg2' + '.png', dpi = 600, transparent = True, bbox_inches='tight')
#plt.savefig(Default_dir_pdf + '/Fire' + str(sorted[oo]).zfill(3) + '_m12_mcvt_m2_t7_3000_tor3_CR10_t4_mask200_Mg2' + '.pdf', dpi = 600, transparent = True, bbox_inches='tight')
