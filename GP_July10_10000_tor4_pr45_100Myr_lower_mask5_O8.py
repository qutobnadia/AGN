...
for fname in List_diir:
    ...
    fig.suptitle(r"Precessing kinetic jet with low energy flux : Snapshot #" + str(sorted[oo]+1) + " with O8 Mass & Mask 5", fontsize=17, x=0.5, y=1.5) #set a figure title on top
    ...
    Default_dir = '/n/home13/nqutob/AGN_Feedback/ion_snapshots/' + '10000_tor4_pr45_100Myr_lower_mask5_O8'
    ...
    plt.savefig(Default_dir + '/Fire' + str(sorted[oo]).zfill(3) + '_10000_tor4_pr45_100Myr_lower_mask5_O8' + '.png', dpi = 600, transparent = True, bbox_inches='tight')
