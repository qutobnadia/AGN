...
for fname in List_diir:
    ...
    fig.suptitle(r"No jet : Snapshot #" + str(sorted[oo]+1) + " with Temperature & Mask 200", fontsize=17, x=0.5, y=1.5) #set a figure title on top
    ...
    Default_dir = '/n/home13/nqutob/AGN_Feedback/ion_snapshots/' + 'm12_mcvt_default_64_mask200_temp'
    #Default_dir_pdf = '/n/home13/nqutob/AGN_Feedback/ion_snapshots/' + 'm12_mcvt_m2_m12_mcvt_default_64_mask_pdf'
    ...
    plt.savefig(Default_dir + '/Fire' + str(sorted[oo]).zfill(3) + '_m12_mcvt_default_64_mask200_temp' + '.png', dpi = 600, transparent = True, bbox_inches='tight')
    #plt.savefig(Default_dir_pdf + '/Fire' + str(sorted[oo]).zfill(3) + '_m12_mcvt_m2_m12_mcvt_default_64_mask_O6' + '.pdf', dpi = 600, transparent = True, bbox_inches='tight')
