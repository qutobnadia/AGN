...
for fname in List_diir:
    ...
    fig.suptitle(r"Precessing kinetic jet with low energy flux : Snapshot #" + str(sorted[oo]+1) + " with O7 Mass & Mask 200", fontsize=17, x=0.5, y=1.5) #set a figure title on top
